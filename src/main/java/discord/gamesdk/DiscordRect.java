...
public class DiscordRect {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        discord_game_sdk_h.C_INT.withName("left"),
        discord_game_sdk_h.C_INT.withName("top"),
        discord_game_sdk_h.C_INT.withName("right"),
        discord_game_sdk_h.C_INT.withName("bottom")
    ).withName("DiscordRect");
