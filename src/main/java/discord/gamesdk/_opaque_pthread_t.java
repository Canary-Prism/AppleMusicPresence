...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        discord_game_sdk_h.C_LONG.withName("__sig"),
        discord_game_sdk_h.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, discord_game_sdk_h.C_CHAR).withName("__opaque")
